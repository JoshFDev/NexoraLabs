...
const rutas = [
  ...
  {
    metodo: "POST",
    ruta: "/proyecto-habilidad/agregar",
    descripcion: "Crear relación proyecto-habilidad (admin/mentor)"
  },
  ...
  {
    metodo: "GET",
    ruta: "/mis-solicitudes-equipo",
    descripcion: "Solicitudes pendientes de mis equipos (creador/aprueba)"
  },
  ...
  {
    metodo: "PUT",
    ruta: "/equipo/:id/miembros/:miembroId/rol",
    descripcion: "Cambiar rol de integrante (creador/admin/mentor)"
  },
  {
    metodo: "DELETE",
    ruta: "/equipo/:id/miembros/:miembroId",
    descripcion: "Quitar integrante del equipo (creador/admin/mentor)"
  },
  {
    metodo: "POST",
    ruta: "/recurso-aprendizaje/:id/calificar",
    descripcion: "Crear/actualizar mi reseña del recurso (autenticado)"
  },
  {
    metodo: "DELETE",
    ruta: "/recurso-aprendizaje/own/:id/calificacion",
    descripcion: "Eliminar mi reseña del recurso (autenticado)"
  },
  ...
  {
    metodo: "DELETE",
    ruta: "/postulacion-oferta-own/:id",
    descripcion: "Retirar mi postulación pendiente (autenticado)"
  },
  {
    metodo: "GET",
    ruta: "/oferta/:id/postulaciones",
    descripcion: "Postulaciones de una oferta (admin/mentor o publicador)"
  },
  {
    metodo: "PUT",
    ruta: "/postulacion-oferta/:id/estado",
    descripcion: "Responder postulación de oferta (admin/mentor o publicador)"
  }
];
