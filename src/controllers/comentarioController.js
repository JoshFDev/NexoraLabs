...
export const crearComentarioProyecto = async (req, res) => {
  try {
    ...
    const conDatos = await Comentario.findById(comentarioRegistrado._id).populate(
      "usuario_id",
...
export const eliminarComentario = async (req, res) => {
  try {
    ...
    const esCreadorDelProyecto =
      comentario.proyecto_id && String(comentario.proyecto_id.creador_id) === String(req.usuario.id);
