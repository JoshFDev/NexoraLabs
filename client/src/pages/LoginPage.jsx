...
const IconoGoogle = () => (
  <svg viewBox="0 0 24 24" width="18" height="18">
    ...
    <path
      fill="#EA4335"
      d="M12 4.75c1.77 0 3.35.61 4.6 1.8l3.42-3.42A12.03 12.03 0 0 0 1.29 6.62l3.98 3.09C6.22 6.86 8.87 4.75 12 4.75z"
    />
  </svg>
);
...
const IconoLinkedIn = () => (
  <svg viewBox="0 0 24 24" width="18" height="18">
    <path
      fill="#0A66C2"
      d="M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.36V9h3.41v1.56h.05c.47-.9 1.63-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.46v6.28zM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12zM7.12 20.45H3.56V9h3.56v11.45z"
    />
  </svg>
);
...
function LoginPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setError(
        err.response ? 'Usuario o contraseña incorrectos.' : 'No pudimos conectar con el servidor. Inténtalo de nuevo.'
      );
      setErrores({ email: '', password: '' });
      setAgitar(true);
      setTimeout(() => setAgitar(false), 500);
